...
const portfolios = __importStar(require("../controllers/portfolios"));
...
router.patch("/:id", validateObjectId_1.default, portfolios.patchPortfolio);
router.delete("/:id", validateObjectId_1.default, portfolios.deletePortfolio);
